...
- `kind-flux-validation-runbook.md` gives AI agents and users a general kind-first setup guide, including GitHub deploy-key prerequisites, Flux reconciliation, validation-status configuration, and inspection steps.

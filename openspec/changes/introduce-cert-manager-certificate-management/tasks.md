...
- [x] 3.6 Bind the issued TLS Secret to the existing Envoy Gateway HTTPS listener and CrateCheck route with a narrow cross-namespace ReferenceGrant.
...
- [ ] 5.5 Validate cert-manager namespace, CRDs, controller resources, controller readiness, ClusterIssuer readiness, Certificate readiness, TLS Secret creation, trusted CrateCheck HTTPS, and CrateCheck cert-manager check output.
